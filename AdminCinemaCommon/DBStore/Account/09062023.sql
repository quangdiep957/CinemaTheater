...
--
-- Host: 35.234.5.238    Database: db_cinema_account
-- ------------------------------------------------------
...
INSERT INTO `account` VALUES ('1b2a06fb-01db-11ee-b204-0242ac130002','vucongdoan306','Congdoan1808',5,'Vũ Công Đoàn',0,'2023-05-31','0936561533',0,'',0,'2023-06-03 13:51:46','noadvcxxi@gmail.com',NULL,NULL,NULL),('4555fff1-cd74-11ed-a44f-907841e9040c','admin','admin@123',1,'Admin',1,'2001-08-18',NULL,NULL,NULL,NULL,NULL,NULL,'30ef7032-01e4-11ee-b204-0242ac130002','db_thanh_xuan',''),('49fcb4a6-0025-11ee-9013-88aedd095151','vcdoan','vcdoan',2,'Vũ Công Đoàn ',1,'2001-08-17','0964582884',NULL,NULL,NULL,'2023-06-01 09:37:45','lhuy2001@gmail.com','7e18991f-e768-11ed-8b5d-907841e9040c','db_cinema_dev_01',''),('62e2a607-01e7-11ee-b204-0242ac130002','nthong123','nthong123',5,'Nguyễn Thị Hồng',1,'2001-01-31','0983743242',0,'',0,'2023-06-03 15:19:40','nthong@gmail.com',NULL,NULL,NULL),('69d3e4b8-e306-11ed-857f-88aedd095151','taikhoan1','Congdoan1808.',5,'Công Đoàn',1,'2001-08-18','0936561355',0,'0000001',1,'2023-04-25 00:00:00','congdoan123@gmail.com','7e18991f-e768-11ed-8b5d-907841e9040c','db_cinema_dev_01',NULL),('72ab2cc8-01e8-11ee-b204-0242ac130002','nttmaii','nttmai',5,'Nguyễn Thị Tuyết Mai',0,'2004-06-01','0937378278',0,'',0,'2023-06-03 15:27:16','nttmai@gmail.com',NULL,NULL,NULL),('9e91cebd-01e7-11ee-b204-0242ac130002','vmcuong','vmcuong',5,'Vũ Minh Cường',0,'2007-06-04','0932783784',0,'',0,'2023-06-03 15:21:20','vmcuong@gmail.com',NULL,NULL,NULL),('ab869e84-e80c-11ed-906e-907841e9040c','admin1','admin',1,'Hoàng',1,'2023-06-14','',NULL,NULL,NULL,'2023-05-01 17:41:03','','7e18991f-e768-11ed-8b5d-907841e9040c','db_cinema_dev_01',''),('b4865e4e-01e7-11ee-b204-0242ac130002','nhhanh','nhhanh',5,'Nguyễn Hồng Hanh',1,'2011-06-15','0993723832',0,'',0,'2023-06-03 15:21:57','nhhanh@gmail.com',NULL,NULL,NULL),('d08a05fe-fed1-11ed-bc58-88aedd095151','vucongdoan1','Congdoan1808.',2,'Công Đoàn',NULL,NULL,NULL,NULL,NULL,NULL,'2023-05-30 17:08:42',NULL,'7e18991f-e768-11ed-8b5d-907841e9040c','db_cinema_dev_01',''),('df923bfa-e80f-11ed-906e-907841e9040c','nttmai','admin',2,'Nguyễn thị Tuyết Mai',NULL,NULL,NULL,NULL,NULL,NULL,'2023-05-01 18:04:09',NULL,'7e18991f-e768-11ed-8b5d-907841e9040c','db_cinema_dev_01',''),('e58ee3e9-fecd-11ed-bc58-88aedd095151','vucongdoan188','Congdoan1808',2,'Vũ Công Đoàn',1,'2001-08-17','964582884',NULL,NULL,NULL,'2023-05-30 16:39:39','noadvcxxi@gmail.com','7e18991f-e768-11ed-8b5d-907841e9040c','db_cinema_dev_01',''),('e99b6488-f979-11ed-906e-907841e9040c','mdoanbbb','Congdoan1808.',5,'Minh Đoàn',0,'2023-05-01','0838336272',0,'',0,'2023-05-23 21:55:52','mdoanbb@gamil.com',NULL,NULL,NULL),('f1e74434-01e7-11ee-b204-0242ac130002','ntnga','ntnga',5,'Nguyễn Thị Nga',1,'2005-06-07','0389283928',0,'',0,'2023-06-03 15:23:40','ntnga@gmail.com',NULL,NULL,NULL),('f592ab85-e74b-11ed-8b5d-907841e9040c','congdoan5','congdoan1',2,'Đoàn',NULL,NULL,NULL,NULL,NULL,NULL,'2023-05-30 15:42:37',NULL,'7e18991f-e768-11ed-8b5d-907841e9040c','db_cinema_dev_01','');
...
INSERT INTO `cinematenant` VALUES ('30ef7032-01e4-11ee-b204-0242ac130002','db_thanh_xuan','Rạp Thanh Xuân'),('7e18991f-e768-11ed-8b5d-907841e9040c','db_cinema_dev_01','Rạp chiếu phim Mỹ Đình');
...
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `GetAccountByAccountName`(IN $AccountName varchar(50))
BEGIN
  SELECT
    a.AccountName,
    a.Password,
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Proc_DeleteAccount`(IN $AccountID char(36))
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Proc_GetAccountByAccountName`(IN $AccountName varchar(50))
BEGIN
  SELECT
    a.AccountName,
    a.Password,
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Proc_GetAccountByID`(IN $AccountID char(36))
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Proc_GetListCinema`()
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Proc_GetTokenUser`(IN $account_name varchar(50), IN $account_password varchar(50))
    COMMENT 'Thủ tục lấy ra account id và role'
BEGIN
  SELECT
    a.AccountID AS AccountID,
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Proc_InsertNewAccount`(IN $AccountName varchar(50), IN $Password varchar(50), IN $Role int, IN $Name varchar(255), IN $Gender int, IN $DateOfBirth date, IN $Email varchar(100), IN $CinemaID char(36), IN $Avatar varchar(500), IN $PhoneNumber varchar(10))
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Proc_InsertNewCinemaTenant`(IN $DBName varchar(500), IN $CinemaName text)
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Proc_InsertNewUser`(IN $AccountName varchar(50), IN $Name varchar(255), IN $Password varchar(50), IN $DateOfBirth date, IN $Gender int, IN $Email varchar(100), IN $PhoneNumber varchar(10))
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Proc_UpdateAccount`(IN $AccountID char(36), IN $Password varchar(50), IN $Role int, IN $Name varchar(255), IN $Gender int, IN $DateOfBirth date, IN $PhoneNumber varchar(10), IN $Email varchar(100), IN $CinemaID char(36), IN $Avatar varchar(500))
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `Proc_UpdatePasswordAccount`(IN $AccountName varchar(50), IN $Password varchar(50))
BEGIN
  UPDATE account a
  SET a.Password = $Password
  WHERE a.AccountName = $AccountName;
...
-- Dump completed on 2023-06-09 17:12:19
