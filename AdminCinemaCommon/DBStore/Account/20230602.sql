...
INSERT INTO `cinematenant` VALUES ('39a8eb9e-001c-11ee-9013-88aedd095151','Hhhh','Rạp thử nghiệm'),('7e18991f-e768-11ed-8b5d-907841e9040c','db_cinema_dev_01','Rạp chiếu phim Mỹ Đình'),('87373257-0115-11ee-9603-88aedd095151','b422ea7c-2385-4cb8-8aad-251aa56d4cdd','dsffsdd'),('9f5e44d5-0116-11ee-9603-88aedd095151','8c7d0f85-9ea9-41bf-a4ab-d08d129d1c9f','Tesst'),('e8a7521a-f4c5-11ed-906e-907841e9040c','fake','Rạp Cầu Giấy'),('faf64419-001b-11ee-9013-88aedd095151','260f914e-9280-4626-a760-b41d0bbc0100','Rạp Duy Tân');
...
DELIMITER ;;
CREATE   PROCEDURE `GetAccountByAccountName`(IN $AccountName varchar(50))
BEGIN
  SELECT
    a.AccountName,
    a.Password,
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE   PROCEDURE `Proc_DeleteAccount`(IN $AccountID char(36))
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE   PROCEDURE `Proc_GetAccountByAccountName`(IN $AccountName varchar(50))
BEGIN
  SELECT
    a.AccountName,
    a.Password,
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE   PROCEDURE `Proc_GetAccountByID`(IN $AccountID char(36))
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE   PROCEDURE `Proc_GetTokenUser`(IN $account_name varchar(50), IN $account_password varchar(50))
    COMMENT 'Thủ tục lấy ra account id và role'
BEGIN
  SELECT
    a.AccountID AS AccountID,
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE   PROCEDURE `Proc_InsertNewAccount`(IN $AccountName varchar(50), IN $Password varchar(50), IN $Role int, IN $Name varchar(255), IN $Gender int, IN $DateOfBirth date, IN $Email varchar(100), IN $CinemaID char(36), IN $Avatar varchar(500), IN $PhoneNumber varchar(10))
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE   PROCEDURE `Proc_InsertNewCinemaTenant`(IN $DBName varchar(500), IN $CinemaName text)
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE   PROCEDURE `Proc_InsertNewUser`(IN $AccountName varchar(50), IN $Name varchar(255), IN $Password varchar(50), IN $DateOfBirth date, IN $Gender int, IN $Email varchar(100), IN $PhoneNumber varchar(10))
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE   PROCEDURE `Proc_UpdateAccount`(IN $AccountID char(36), IN $Password varchar(50), IN $Role int, IN $Name varchar(255), IN $Gender int, IN $DateOfBirth date, IN $PhoneNumber varchar(10), IN $Email varchar(100), IN $CinemaID char(36), IN $Avatar varchar(500))
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE   PROCEDURE `Proc_UpdatePasswordAccount`(IN $AccountName varchar(50), IN $Password varchar(50))
BEGIN
  UPDATE account a
  SET a.Password = $Password
  WHERE a.AccountName = $AccountName;
...
-- Dump completed on 2023-06-02 16:37:45
