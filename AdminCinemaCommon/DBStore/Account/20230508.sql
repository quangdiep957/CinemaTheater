...
BEGIN
select a.AccountName,a.Password,a.Role,a.Name,a.Gender,a.DateOfBirth,a.PhoneNumber,a.Email,a.Avatar from account a where a.AccountName = $AccountName;
END ;;
DELIMITER ;
...
BEGIN
update account a set a.Password = $Password where a.AccountName = $AccountName;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-05-08 16:31:44
