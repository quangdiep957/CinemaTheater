...
INSERT INTO `moviecategorydetail` VALUES ('6e718478-a0c0-4425-bd2c-75a969a286ab','54687a5a-d207-11ed-afa1-0242ac120002'),('d6ed7e34-fada-474f-9682-2c2cf3ba4bed','54687a5a-d207-11ed-afa1-0242ac120002'),('3aa6c663-36d9-4797-94b9-dcd6dcc51e2e','5e260de6-d207-11ed-afa1-0242ac120002'),('668aede5-2336-459a-b0ad-26969ea141d9','5e260de6-d207-11ed-afa1-0242ac120002'),('81ea1112-6d7f-4dee-85d8-15c75785de3c','5e260de6-d207-11ed-afa1-0242ac120002'),('ac6b11da-ebef-4889-9f77-a971c292066b','61ab1fc2-d208-11ed-a44f-907841e9040c'),('81ea1112-6d7f-4dee-85d8-15c75785de3c','7685b7d8-d207-11ed-afa1-0242ac120002'),('de609974-d6c1-45af-ab26-517885625c6f','7685b7d8-d207-11ed-afa1-0242ac120002'),('81ea1112-6d7f-4dee-85d8-15c75785de3c','b4bb3e2e-d207-11ed-afa1-0242ac120002');
...
BEGIN
 ...
 Declare $Type int DEFAULT 1;
  ...
  WHILE i <= $Row DO
    WHILE j <= $Col DO
    select c.Type into $Type from seat c WHERE c.RowSeat = i and c.ColSeat = j and c.RoomID = $RoomID limit 1; 
...
select YEAR(NOW()) into $ThisYear;
    ...
    h.ShowDate
    from history h where h.MovieID = $MovieID Group By DATE_FORMAT(h.ShowDate, '%d-%m'),h.ShowDate;
    
    select * from tmpTable order by ShowDate;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
select Keyword,KeyValue from DBOptions;
...
BEGIN
    ...
    insert into tmpTable(CheckoutID,
        ...
        select * from tmpTable order by CreatedDate, ParentID,Type;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    select lc.CinemaName,lc.CinemaAddress,lc.Hotline,lc.About,lc.MST into $CinemaName,$CinemaAddress,$Hotline,$About,$MST from listcinema lc limit 1;
    ...
    $About as About,
    $MST as MST
    from templateticketmovie t inner join movie m on t.MovieID = m.MovieID 
    where m.FromDate <= NOW() and m.ToDate >= NOW();
    
    select * from tmpTable order by ReleaseDate,Type;
...
select Convert(KeyValue,decimal(22,4)) into $Normal_Cost from DBOptions d WHERE d.Keyword = 'Default_Seat_Normal' limit 1;
select Convert(KeyValue,decimal(22,4)) into $VIP_Cost from DBOptions d WHERE d.Keyword = 'Default_Seat_VIP' limit 1;
  DROP TEMPORARY TABLE IF EXISTS tmpTable;
  CREATE TEMPORARY TABLE IF NOT EXISTS tmpTable (
    ID char(36)
  );
  ...
  INSERT INTO moviecategorydetail
   ...
   insert into templateticketmovie(TemplateTicketID,MovieID,Type,Cost) values(UUID(),$MovieID,1,$Normal_Cost);
   insert into templateticketmovie(TemplateTicketID,MovieID,Type,Cost) values(UUID(),$MovieID,2,$VIP_Cost);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_InsertToHistory`(
...
select UUID() into $parent_id;

select t.Cost into $Cost_N from templateticketmovie t where t.MovieID = $MovieID and t.Type = 1;

select t.Cost into $Cost_V from templateticketmovie t where t.MovieID = $MovieID and t.Type = 2;
...
BEGIN
Update templateticketmovie t set t.Cost = $Cost where t.TemplateTicketID = $TemplateTicketID; 
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-04-28 17:16:41
