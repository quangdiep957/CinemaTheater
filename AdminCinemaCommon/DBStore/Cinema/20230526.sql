...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Bảng lưu danh mục ngôn ngữ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `language` VALUES ('EN','English'),('JP','Japanese'),('VN','Việt Nam');
...
BEGIN
	update dboptions set KeyValue = $KeyValue where Keyword = $Keyword;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-05-26 16:58:12
