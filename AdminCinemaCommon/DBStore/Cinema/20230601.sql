...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_ChangeDBOptions`(IN $Keyword varchar(255), IN $KeyValue varchar(255))
BEGIN
  UPDATE dboptions
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_GetCinemaInfo`()
BEGIN
	drop temporary table if exists tmpTable;
    create temporary table tmpTable(
		CinemaID char(36),
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_GetListLanguage`()
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Proc_InsertNewLanguage`(IN $LanguageCode varchar(10), IN $LanguageName varchar(50))
...
-- Dump completed on 2023-06-01 17:27:37
