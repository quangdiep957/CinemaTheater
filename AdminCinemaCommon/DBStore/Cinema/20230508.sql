...
BEGIN
update DBOptions d set d.KeyValue = $KeyValue where d.Keyword = $Keyword; 
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-05-08 16:32:16
